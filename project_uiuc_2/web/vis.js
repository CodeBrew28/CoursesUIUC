...
$(function() {
  $.get("res/course_data.csv")
   .done(function (data) {
    ...
    // visualize(tree[0])
    visualize({
      name: "Get Rejected by CMU",
      _children: [
        {
          name: "Get accepted into UIUC",
          _children: tree
        }
      ]
    })
...
var visualize = function(treeData) {
    ...
    function click(d) {
        d.color = d.color ? undefined : "green"
    ...
    function update(source) {
        ...
        nodeEnter.append("circle")
            ...
            .style("fill", function(d) {
                return d.children ? "green" : (d._children  ? "lightsteelblue" : (d.color || "#fff"));
            });
